...
Based on the complexity of diagnostic process, it is unlikely to have machine learning classifer that are able to predict a task that is already difficult in human decision.
