...
There are also studies that focus on stressful life events only. The dectection of stressful life events mainly use positive or negative emotion as features. Manual labels for distress content are required for the training data. (cite). The psychology literature has reported that negative events are linked to the 
