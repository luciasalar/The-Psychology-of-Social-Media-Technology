...
and Silver (1989) (cite) found that one-third of the bereaved spouses do not appear to be distressed at any point up to one year after the spouse's death. Thus, subjective ratings of stress are more predictive to mental health conditions.  Scales that measure the subjective rating of stress include Schedule of Recent Life Experiences (SRE) cite(), the Social Readjustment Rating Scale (SRRS) and so on (cite). Another way to measure stress is the interview. Interview measurement is particularly critical in diagnosis because the timing of exposure to the stressor and the 

\subsubsection{types of stress}
random stressors 

chronic and short-term stress (problem of defining the boundary )

change events vs. negative change events
life event checklists emphasis the undesirability as the most relevant issue and the believe of the effect of stress accumulation. 

\subsubsection{uncontrollability of event}


\subsubsection{role strain}
